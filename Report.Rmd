---
title: "Predicting Downhole Equipment Failures"
...
df <- df[,missing <= 0.05] #try 0.05 and 0.1, 0.05 gives better performance
summary(df)
```
...
### 25% of training data (sample test data) F1 score
...
```{r, echo = FALSE}
data <- read.csv("C:/Users/Chris Han/Datathon/finalresults.csv")
knitr::kable(data, caption = "Model Performance on training and testing set")
```
